...
import * as sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: peuuoSKUTVBxQ/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box___7WYj9)} />

      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__lDqD)}
      >
        <div
        ...
        <div className={classNames(defaultcss.all, sty.box__g7Daa)}>
          <div
            className={classNames(
              defaultcss.all,
              defaultcss.__wab_text,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___8N1G)}
        >
          <LinkButton
